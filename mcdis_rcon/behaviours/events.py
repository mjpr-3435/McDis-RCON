...
class on_message(commands.Cog):
    ...
    async def on_guild_channel_pins_update(
        self, channel: discord.abc.GuildChannel, last_pin: datetime
    ) -> None:
    ...
    @commands.Cog.listener()
    async def on_socket_raw_send(self, payload: str | bytes) -> None:
    ...
    @commands.Cog.listener()
    async def on_stage_instance_delete(self, stage_instace: discord.StageInstance) -> None:
...
async def setup(client: McDisClient) -> None:
