...
def backups_embed(process: Process) -> discord.Embed:
    ...
    if len(mrkd_zips)!= 0: embed.set_footer(text = 184*blank_space + '\n' + _('If you want to load or delete a backup, select it from the dropdown below.'))
    else: 
        embed.description = f'```{_("No backups were found.")}```'
