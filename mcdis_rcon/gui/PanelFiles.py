...
class StateButton(discord.ui.Button[Any]):
    ...
    async def callback(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.response.edit_message(embed=FilesEmbed(self.view.client), view=self.view)
...
class FilesEmbed(discord.Embed):
    ...
    def _add_description(self) -> Any:
        self.add_field(
            inline=True,
            name='',
            value=self.client._('This banner lets you configure the File Manager functions.'),
        )
